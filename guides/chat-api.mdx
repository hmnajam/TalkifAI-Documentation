...
| `greeting` | Agent's opening message. `null` if agent waits for user to speak first |
...
| `user_identifier` | string | ❌ | **Important:** End-user email for memory linking across sessions |

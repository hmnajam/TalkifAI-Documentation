...
<Frame>
  ![System prompt editor](/images/create-agent-system-prompt.png)
</Frame>
...
<Frame>
  ![Pipeline configuration — Voice, LLM, STT](/images/create-agent-pipeline-config.png)
</Frame>
...
<Frame>
  ![Functions configuration](/images/create-agent-functions.png)
</Frame>

...
| **Languages** | ✅ | The language(s) the agent will understand and speak |
| **Agent Mode** | ✅ | Start with **Private** for testing, then change to Public or Commercial |
...
<Info>
  Voice availability depends on your organization's API keys and configured providers.
</Info>
